...
Write-Host "========================================="
Write-Host
Write-Host "Credits to Tim Brown (@timbrownls20) for supporting materials."
Write-Host

# Reference: https://codebuckets.com/2017/08/04/5-ways-to-extract-the-computer-name-from-a-network-file-path-with-powershell/ (Tim Brown, @timbrownls20, 2017)
